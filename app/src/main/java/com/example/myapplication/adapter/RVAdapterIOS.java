...
public class RVAdapterIOS extends RecyclerView.Adapter<RVAdapterIOS.ViewHolder> {

    Context context;
    List<User> UserList;

    public RVAdapterIOS(Context context, List<User> TempList, FragmentActivity activity) {
    ...
    @Override
    public RVAdapterIOS.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list, parent, false);
        RVAdapterIOS.ViewHolder viewHolder = new RVAdapterIOS.ViewHolder(view);
        return viewHolder;
    }


    public void onBindViewHolder(@NonNull final RVAdapterIOS.ViewHolder holder, int position) {
