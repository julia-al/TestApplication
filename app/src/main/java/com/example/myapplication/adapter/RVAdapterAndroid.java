...
public class RVAdapterAndroid extends RecyclerView.Adapter<RVAdapterAndroid.ViewHolder> {

    Context context;
    List<User> UserList;

    public RVAdapterAndroid(Context context, List<User> TempList, FragmentActivity activity) {
    ...
    @Override
    public RVAdapterAndroid.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list, parent, false);
        RVAdapterAndroid.ViewHolder viewHolder = new RVAdapterAndroid.ViewHolder(view);
        return viewHolder;
    }

    public void onBindViewHolder(@NonNull final RVAdapterAndroid.ViewHolder holder, int position) {
