...
public class RVAdapterAnalytics extends RecyclerView.Adapter<RVAdapterAnalytics.ViewHolder> {

    Context context;
    List<User> UserList;

    public RVAdapterAnalytics(Context context, List<User> TempList, FragmentActivity activity) {
    ...
    @Override
    public RVAdapterAnalytics.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list, parent, false);
        RVAdapterAnalytics.ViewHolder viewHolder = new RVAdapterAnalytics.ViewHolder(view);
        return viewHolder;
    }


    public void onBindViewHolder(@NonNull final RVAdapterAnalytics.ViewHolder holder, int position) {
