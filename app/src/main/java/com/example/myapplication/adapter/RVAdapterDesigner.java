...
public class RVAdapterDesigner extends RecyclerView.Adapter<RVAdapterDesigner.ViewHolder> {

    Context context;
    List<User> UserList;

    public RVAdapterDesigner(Context context, List<User> TempList, FragmentActivity activity) {
