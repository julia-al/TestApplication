...
public class RVAdapterPR extends RecyclerView.Adapter<RVAdapterPR.ViewHolder> {

    Context context;
    List<User> UserList;

    public RVAdapterPR(Context context, List<User> TempList, FragmentActivity activity) {
    ...
    @Override
    public RVAdapterPR.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list, parent, false);
        RVAdapterPR.ViewHolder viewHolder = new RVAdapterPR.ViewHolder(view);
        return viewHolder;
    }


    public void onBindViewHolder(@NonNull final RVAdapterPR.ViewHolder holder, int position) {
