...
public class RVAdapterBackend extends RecyclerView.Adapter<RVAdapterBackend.ViewHolder> {

    Context context;
    List<User> UserList;

    public RVAdapterBackend(Context context, List<User> TempList, FragmentActivity activity) {
    ...
    @Override
    public RVAdapterBackend.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list, parent, false);
        RVAdapterBackend.ViewHolder viewHolder = new RVAdapterBackend.ViewHolder(view);
        return viewHolder;
    }


    public void onBindViewHolder(@NonNull final RVAdapterBackend.ViewHolder holder, int position) {
