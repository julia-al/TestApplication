...
public class RVAdapterQA extends RecyclerView.Adapter<RVAdapterQA.ViewHolder> {

    Context context;
    List<User> UserList;

    public RVAdapterQA(Context context, List<User> TempList, FragmentActivity activity) {
    ...
    @Override
    public RVAdapterQA.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list, parent, false);
        RVAdapterQA.ViewHolder viewHolder = new RVAdapterQA.ViewHolder(view);
        return viewHolder;
    }


    public void onBindViewHolder(@NonNull final RVAdapterQA.ViewHolder holder, int position) {
