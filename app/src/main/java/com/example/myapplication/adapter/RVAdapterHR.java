...
public class RVAdapterHR extends RecyclerView.Adapter<RVAdapterHR.ViewHolder> {

    Context context;
    List<User> UserList;

    public RVAdapterHR(Context context, List<User> TempList, FragmentActivity activity) {
    ...
    @Override
    public RVAdapterHR.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list, parent, false);
        RVAdapterHR.ViewHolder viewHolder = new RVAdapterHR.ViewHolder(view);
        return viewHolder;
    }


    public void onBindViewHolder(@NonNull final RVAdapterHR.ViewHolder holder, int position) {
