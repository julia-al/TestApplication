...
public class RVAdapterFrontend extends RecyclerView.Adapter<RVAdapterFrontend.ViewHolder> {

    Context context;
    List<User> UserList;

    public RVAdapterFrontend(Context context, List<User> TempList, FragmentActivity activity) {
    ...
    @Override
    public RVAdapterFrontend.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list, parent, false);
        RVAdapterFrontend.ViewHolder viewHolder = new RVAdapterFrontend.ViewHolder(view);
        return viewHolder;
    }


    public void onBindViewHolder(@NonNull final RVAdapterFrontend.ViewHolder holder, int position) {
