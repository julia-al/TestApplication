...
public class RVAdapterSupport extends RecyclerView.Adapter<RVAdapterSupport.ViewHolder> {

    Context context;
    List<User> UserList;

    public RVAdapterSupport(Context context, List<User> TempList, FragmentActivity activity) {
