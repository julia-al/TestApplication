...
public class RVAdapterFA extends RecyclerView.Adapter<RVAdapterFA.ViewHolder>{

    Context context;
    List<User> UserList;

    public RVAdapterFA(Context context, List<User> TempList, FragmentActivity activity) {
    ...
    @Override
    public RVAdapterFA.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list, parent, false);
        RVAdapterFA.ViewHolder viewHolder = new RVAdapterFA.ViewHolder(view);
        return viewHolder;
    }

    public void onBindViewHolder(@NonNull final RVAdapterFA.ViewHolder holder, int position) {
