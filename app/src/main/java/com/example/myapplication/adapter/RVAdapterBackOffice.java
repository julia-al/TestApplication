...
public class RVAdapterBackOffice extends RecyclerView.Adapter<RVAdapterBackOffice.ViewHolder> {

    Context context;
    List<User> UserList;

    public RVAdapterBackOffice(Context context, List<User> TempList, FragmentActivity activity) {
    ...
    @Override
    public RVAdapterBackOffice.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list, parent, false);
        RVAdapterBackOffice.ViewHolder viewHolder = new RVAdapterBackOffice.ViewHolder(view);
        return viewHolder;
    }


    public void onBindViewHolder(@NonNull final RVAdapterBackOffice.ViewHolder holder, int position) {
